...
const Str kAllStrings[] = {
    ...
    Str::Exit, Str::NewItem, Str::ListNamePrompt, Str::ListDefault,
    Str::ListRename, Str::ListDelete, Str::ListDeleteMsg, Str::Completed,
    Str::Clear, Str::DeleteItemMsg, Str::ClearAllMsg, Str::ConfirmOk,
    Str::ConfirmCancel, Str::LoadFailedMsg, Str::ThemeHeader,
